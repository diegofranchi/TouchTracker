...
class DrawView: UIView, UIGestureRecognizerDelegate {
    ...
    //MARK: - Gold Challenge: Speed and Size
    var maximumVelocity: CGFloat = CGFloat.leastNonzeroMagnitude
    var minimumVelocity: CGFloat = CGFloat.greatestFiniteMagnitude
    var currentVelocity: CGFloat = 0
    var currentLineWidth: CGFloat {
        let maximumWidth: CGFloat = 20
        let minimumWidth: CGFloat = 1
        let lineWidth = (maximumVelocity - currentVelocity) / (maximumVelocity - minimumVelocity) * (maximumWidth - minimumWidth) + minimumWidth
        return lineWidth
    }
    ...
    @objc func moveLine(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        //MARK: - Gold Challenge: Speed and Size
        let xyVelocity = gestureRecognizer.velocity(in: self)
        currentVelocity = hypot(xyVelocity.x, xyVelocity.y)
        maximumVelocity = max(maximumVelocity, currentVelocity)
        minimumVelocity = min(minimumVelocity, currentVelocity)
        print("currentVelocity: \(currentVelocity)")
        print("maximumVelocity: \(maximumVelocity)")
        print("minimumVelocity: \(minimumVelocity)")
        //MARK: - Silver Challenge: Mysterious Lines
